...
"%JAVA_HOME%\bin\java" %INSIDER_PARAMETERS% -classpath %LOCALCLASSPATH% lrg.insider.gui.InsiderGUIMain %1 %2 %3 %4 %5 %6 %7 %8 %9
rem "%JAVA_HOME%\bin\java" %INSIDER_PARAMETERS% -classpath %LOCALCLASSPATH% -Xdebug -Xrunjdwp:transport=dt_socket,server=y,suspend=n,address=5005 lrg.insider.gui.InsiderTextMain %1 %2 %3 %4 %5 %6 %7 %8 %9
