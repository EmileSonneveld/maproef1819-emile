...
/* 20 */     super(new Descriptor("Refused Parent Bequest", "class"));
/*    */ 
/*    */     
/* 23 */     this.NOM = 0.0D;
/*    */   }
...
/*    */     
/* 51 */     return (NProtMInBase > 2.0D && lowUsageRatio && lowOverridingRatio);
/*    */   }
/*    */   
/*    */   private boolean childClassIsNotDwarf(AbstractEntityInterface derivedClass) {
/* 55 */     double amw = ((Double)derivedClass.getProperty("AMW").getValue()).doubleValue();
/* 56 */     double wmc = ((Double)derivedClass.getProperty("WMC").getValue()).doubleValue();
/*    */     
/* 58 */     if (amw > Threshold.AMW_AVG && 
/* 59 */       wmc > Threshold.WMC_AVG && 
/* 60 */       this.NOM > Threshold.NOM_AVG) return true; 
/*    */     return false;
/*    */   }
/*    */   public boolean applyFilter(AbstractEntityInterface derivedClass) {
/* 64 */     NotComposedFilteringRule notComposedFilteringRule = new NotComposedFilteringRule(new IsConstructor());
/* 65 */     this.NOM = derivedClass.contains("method group").applyFilter(notComposedFilteringRule).size();
/* 66 */     if (this.NOM == 0.0D) return false;
/*    */     
/* 68 */     if (childClassIgnoresBequest(derivedClass) && 
/* 69 */       childClassIsNotDwarf(derivedClass)) return true; 
/*    */     return false;
/*    */   }
/*    */ }


/* Location:              C:\Users\emill\Dropbox\slimmerWorden\2018-2019-Semester2\THESIS\iPlasma6\tools\iPlasma\classes.zip!\classes\lrg\insider\plugins\filters\memoria\classes\RefusedParentBequest.class
