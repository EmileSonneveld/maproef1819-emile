...
/*    */ 
/*    */ 
/*    */ public class AISubsystemPlot
/*    */   extends AbstractVisualization
/*    */ {
/* 22 */   public AISubsystemPlot() { super("AI Plot (subsystems)", "Abstractness Instability Plot", "system"); }
/*    */ 
/*    */   
/*    */   public void view(AbstractEntityInterface entity) {
/* 26 */     FilteringRule significantPackages = new FilteringRule("TOTALDEP", ">", "subsystem", 10.0D);
/* 27 */     List set = entity.getGroup("subsystem group").applyFilter(significantPackages).getElements();
...
/* Location:              C:\Users\emill\Dropbox\slimmerWorden\2018-2019-Semester2\THESIS\iPlasma6\tools\iPlasma\classes.zip!\classes\lrg\insider\plugins\visualizations\AISubsystemPlot.class
